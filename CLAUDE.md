...
- `data_dictionary_container.csv` and `data_dictionary_household.csv` are orphaned from previous process
- Not regenerated by current script - can be ignored or deleted
